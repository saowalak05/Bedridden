...
class AddST extends StatefulWidget {
  const AddST({Key? key}) : super(key: key);

  @override
  State<AddST> createState() => _AddSTState();
}

class _AddSTState extends State<AddST> {
  Completer<GoogleMapController> _controller = Completer();

  String? typelocationST;
  ...
  Future<Null> proccessUplodlocation() async {
    await Firebase.initializeApp().then((value) async {
      LocationSTModel model = LocationSTModel(
        locationST: typelocationST!,
        lat: lat!,
        lng: lng!,
      );
          ...
          children: [
            Container(
              ...
              child: RadioListTile(
                ...
                value: 'ร้านค้า',
                groupValue: typelocationST,
                onChanged: (value) {
                  setState(
                    () {
                      typelocationST = value as String?;
                    },
                  );
                },
              ),
